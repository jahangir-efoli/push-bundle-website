        ...
        {features.map((f, i) => {
          ...
          return (
            <button
              ...
              style={
                selected
                  ? { backgroundImage: "linear-gradient(90deg,#3b82f6,#22d3ee)",borderColor: "transparent" }
                  : undefined
              }
              className={cn(
                "pbfs-tab inline-flex cursor-pointer border items-center gap-2 rounded-md px-5 py-2.5 text-sm font-semibold transition-colors duration-200",
                selected
